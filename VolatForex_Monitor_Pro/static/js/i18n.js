...
const translations = {
    'pt': {
        ...
        'goal_reached_greeting': 'Parabéns',
        ...
        'goal_recommendation': 'Pare de operar por hoje e volte amanhã com a mesma disciplina.',
        'goal_modal_recommendation_label': 'Recomendação:',
        'goal_hashtags': '#StopLoss #StopGain #Disciplina',
        
        // Loss Limit Modal
        'loss_limit_title': '🚨 Atenção! Limite de Perda Atingido! 🚨',
        'loss_limit_greeting': 'Atenção',
        ...
        'loss_recommendation': 'Feche a plataforma, revise suas operações e volte amanhã com a mente renovada.',
        'loss_modal_recommendation_label': 'Recomendação:',
        ...
        'error_session_expired': 'Sua sessão expirou. Faça login novamente.',
        
        // Advanced Charts Modal
        'technical_analysis': 'Volat Scalper',
        ...
        'zscore': 'Real Volatility',
        'rsi': 'RSI',
        'visualization': 'Visualização:',
        'show_points': 'Mostrar Pontos',
        'chart_update_frequency': 'Frequência de Atualização:',
        'last_price': 'Último Preço',
        'hull_value': 'Hull MA',
        'zscore_value': 'Real Volatility',
        'rsi_value': 'RSI',
    ...
    'en': {
        ...
        'goal_reached_greeting': 'Congratulations',
        ...
        'goal_recommendation': 'Stop trading for today and come back tomorrow with the same discipline.',
        'goal_modal_recommendation_label': 'Recommendation:',
        'goal_hashtags': '#StopLoss #StopGain #Discipline',
        
        // Loss Limit Modal
        'loss_limit_title': '🚨 Warning! Loss Limit Reached! 🚨',
        'loss_limit_greeting': 'Warning',
        ...
        'loss_recommendation': 'Close the platform, review your trades and come back tomorrow with a renewed mind.',
        'loss_modal_recommendation_label': 'Recommendation:',
        ...
        'chart_update_frequency': 'Update Frequency:',
    ...
    'es': {
        ...
        'goal_reached_greeting': 'Felicidades',
        ...
        'goal_recommendation': 'Deja de operar por hoy y vuelve mañana con la misma disciplina.',
        'goal_modal_recommendation_label': 'Recomendación:',
        'goal_hashtags': '#StopLoss #StopGain #Disciplina',
        
        // Loss Limit Modal
        'loss_limit_title': '🚨 ¡Atención! ¡Límite de Pérdida Alcanzado! 🚨',
        'loss_limit_greeting': 'Atención',
        ...
        'loss_recommendation': 'Cierra la plataforma, revisa tus operaciones y vuelve mañana con la mente renovada.',
        'loss_modal_recommendation_label': 'Recomendación:',
        ...
        'error_session_expired': 'Su sesión ha expirado. Inicie sesión nuevamente.',
        ...
        'chart_update_frequency': 'Frecuencia de Actualización:',
    ...
    'fr': {
        ...
        'goal_reached_greeting': 'Félicitations',
        ...
        'goal_recommendation': 'Arrêtez de trader aujourd\'hui et revenez demain avec la même discipline.',
        'goal_modal_recommendation_label': 'Recommandation:',
        'goal_hashtags': '#StopLoss #StopGain #Discipline',
        
        // Loss Limit Modal
        'loss_limit_title': '🚨 Attention! Limite de Perte Atteinte! 🚨',
        'loss_limit_greeting': 'Attention',
        ...
        'loss_recommendation': 'Fermez la plateforme, révisez vos trades et revenez demain avec un esprit renouvelé.',
        'loss_modal_recommendation_label': 'Recommandation:',
        ...
        'chart_update_frequency': 'Fréquence de Mise à Jour:',
    ...
    'de': {
        ...
        'goal_reached_greeting': 'Glückwunsch',
        ...
        'goal_recommendation': 'Hören Sie heute auf zu handeln und kommen Sie morgen mit derselben Disziplin zurück.',
        'goal_modal_recommendation_label': 'Empfehlung:',
        'goal_hashtags': '#StopLoss #StopGain #Disziplin',
        
        // Loss Limit Modal
        'loss_limit_title': '🚨 Achtung! Verlustgrenze Erreicht! 🚨',
        'loss_limit_greeting': 'Achtung',
        ...
        'loss_recommendation': 'Schließen Sie die Plattform, überprüfen Sie Ihre Trades und kommen Sie morgen mit einem erneuerten Geist zurück.',
        'loss_modal_recommendation_label': 'Empfehlung:',
        ...
        'chart_update_frequency': 'Aktualisierungsfrequenz:',
...
function initializeI18n() {
    ...
    if (window.SAVED_LANGUAGE_FROM_SERVER && window.SAVED_LANGUAGE_FROM_SERVER !== '' && window.SAVED_LANGUAGE_FROM_SERVER !== 'None') {
...
window.i18n = {
    t,
    changeLanguage,
    setLanguage: changeLanguage,  // Alias para compatibilidade
