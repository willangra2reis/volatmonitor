...
<body>
                    ...
                    <div class="card h-100 shadow-sm border-start border-info border-4">
                        <div class="card-body py-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-subtitle text-muted dark-mode-text mb-0">Patrimônio (Equity)</h6>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card shadow-sm h-100">
                        ...
                        <div class="card-body">
                            <div id="open-trades-container" style="max-height: 300px; overflow-y: auto; scrollbar-width: none; -ms-overflow-style: none;">
                <style>
    ...
    <script>
        ...
        function calculateOpenTime(openTime) {
            ...
            const now = new Date();
            const tradeTime = new Date(openTime);
        ...
        function updateUI(data, changes) {
            ...
            if (changes.accountInfoChanged) {
                ...
                // Atualizar indicador de resultado do Equity
                const dailyProfit = accountInfo.account_profit || 0;
                ...
                equityResultElement.textContent = formatProfit(dailyProfit);
            ...
            // Calcular trades positivos e negativos
            ...
            document.getElementById('last-update').textContent = moment(updateTime).format('HH:mm:ss');
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('sort-trades-btn').addEventListener('click', function() {
                ...
                // Re-renderizar trades com nova ordenação
                if (window.latest_data && window.latest_data.open_trades) {
                    updateOpenTrades(window.latest_data.open_trades);
                } else if (window.simulatedOpenTrades) {
                    updateOpenTrades(window.simulatedOpenTrades);
                }
            });
